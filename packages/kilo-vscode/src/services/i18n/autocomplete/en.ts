...
export const dict = {
  "kilocode:autocomplete.statusBar.enabled": "$(raya-logo) Autocomplete",
  "kilocode:autocomplete.statusBar.snoozed": "snoozed",
  "kilocode:autocomplete.statusBar.warning": "$(warning) Autocomplete",
  "kilocode:autocomplete.statusBar.tooltip.basic": "Raya Autocomplete",
  ...
  "kilocode:autocomplete.codeAction.title": "Raya: Suggested Edits",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "The Raya Autocomplete is being blocked by a conflict with GitHub Copilot. To fix this, you must disable Copilot's inline suggestions.",
