...
export const dict = {
  "kilocode:autocomplete.statusBar.enabled": "$(raya-logo) 自动补全",
  "kilocode:autocomplete.statusBar.snoozed": "已暂停",
  "kilocode:autocomplete.statusBar.warning": "$(warning) 自动补全",
  "kilocode:autocomplete.statusBar.tooltip.basic": "Raya 自动补全",
  ...
  "kilocode:autocomplete.codeAction.title": "Raya：建议的编辑",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Raya 自动补全因与 GitHub Copilot 冲突而被阻止。要修复此问题，必须禁用 Copilot 的内联建议。",
