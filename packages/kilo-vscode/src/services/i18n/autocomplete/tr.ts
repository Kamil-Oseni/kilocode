...
export const dict = {
  "kilocode:autocomplete.statusBar.enabled": "$(raya-logo) Otomatik tamamlama",
  "kilocode:autocomplete.statusBar.snoozed": "ertelendi",
  "kilocode:autocomplete.statusBar.warning": "$(warning) Otomatik tamamlama",
  "kilocode:autocomplete.statusBar.tooltip.basic": "Raya otomatik tamamlama",
  ...
  "kilocode:autocomplete.codeAction.title": "Raya: Önerilen düzenlemeler",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Raya otomatik tamamlama, GitHub Copilot ile çakışma nedeniyle engelleniyor. Bunu düzeltmek için Copilot'un satır içi önerilerini devre dışı bırakmalısınız.",
