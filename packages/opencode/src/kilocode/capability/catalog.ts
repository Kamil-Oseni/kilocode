...
const entries: Entry[] = [
  ...
  },
  {
    ...
    inputs: ["structured cell values", "XLSX"],
    description: "Create a local Excel workbook with one or more named sheets and return its verified file receipt.",
    result: "Local XLSX file and artifact receipt",
    permission: "edit",
    limits: [
      "Creates a new workbook or replaces the whole destination after approval.",
      "Does not evaluate formulas, run macros, import templates or preserve an existing workbook.",
    ],
  },
  {
  ...
  },
  {
    ...
    inputs: ["structured slide content", "PPTX"],
    description: "Create a local widescreen slide deck with titles, body text and lists.",
    result: "Local PPTX file and artifact receipt",
    permission: "edit",
    limits: [
      "Creates a new deck or replaces the whole destination after approval.",
      "Does not import templates, add images, charts, tables, notes or animation, or embed fonts.",
    ],
  },
  {
