export const dict = {
  ...
  "kiloClaw.conversations.empty": "هنوز مکالمه‌ای وجود ندارد",
  ...
  "kiloClaw.conversations.groupOlder": "قدیمی‌تر",
  ...
  "kiloClaw.message.copied": "در کلیپ‌بورد کپی شد",
  ...
  "kiloClaw.setup.tryKiloClaw": "امتحان Raya Messenger",
  ...
  "kiloClaw.sidebar.used": "استفاده‌شده",
  "kiloClaw.sidebar.tokens": "توکن‌ها",
  "kiloClaw.sidebar.model": "مدل",
  "kiloClaw.sidebar.provider": "ارائه‌دهنده",
  "kiloClaw.sidebar.details": "جزئیات",
  "kiloClaw.sidebar.region": "منطقه",
  "kiloClaw.sidebar.version": "نسخه",
  "kiloClaw.sidebar.channels": "کانال‌ها",
  "kiloClaw.sidebar.noData": "داده‌ای برای نمونه وجود ندارد",
}
