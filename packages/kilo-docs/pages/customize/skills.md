...
- **Kill switch** — set `RAYA_DISABLE_SKILL_SHELL=true` to disable embedded command execution entirely. `KILO_DISABLE_SKILL_SHELL` remains a compatibility alias; either name set to `true` or `1` enables the safety override.
