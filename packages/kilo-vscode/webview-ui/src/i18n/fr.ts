...
export const dict = {
  ...
  "prompt.action.attach": "Joindre des fichiers",
  ...
  "settings.models.hidePromptTraining.description":
    "Masquez les modèles Raya Gateway dont les fournisseurs peuvent utiliser vos prompts à des fins d'entraînement.",
  ...
  "workStyle.onboarding.welcome": "Bienvenue dans Raya",
  ...
  "workStyle.choice.human-in-the-loop.description":
    "Raya s'interrompt et vous présente son plan au fil de son travail.",
  ...
  "deviceAuth.title": "Se connecter à Raya",
  ...
  "profile.action.login": "Se connecter avec Raya",
  ...
  "profile.usage.routing": "La facturation du forfait est active. Le routage via Raya Gateway est {{state}}.",
  ...
  "profile.pass.subscribe": "Obtenez Raya Pass pour ajouter des crédits et gagner des bonus",
  "profile.pass.bonus": "Bonus",
  "profile.pass.usage": "Consommation de ce mois-ci",
  "profile.pass.paid": "Payé",
  "profile.pass.meter": "Consommation mensuelle du Raya Pass",
  ...
  "settings.aboutKiloCode.title": "À propos de Raya",

  "session.messages.welcome":
    "Raya est un assistant de programmation IA. Demandez-lui de créer des fonctionnalités, corriger des bugs ou expliquer votre code.",
  ...
  "settings.language.description":
    "Choisissez la langue de l'interface de Raya. \"Auto\" utilise la langue d'affichage de VS Code.",
  ...
  "settings.experimental.remote.description":
    "Activez le contrôle Remote des sessions via Raya Cloud. Cela affectera également les CLI sur cette machine.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrer les paramètres d'une précédente installation de Raya, y compris les clés d'API des fournisseurs et le modèle par défaut.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Nouveautés de Raya",
