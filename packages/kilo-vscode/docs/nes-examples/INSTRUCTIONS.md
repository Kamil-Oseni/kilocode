...
5. To watch the pipeline live: `View → Output` → pick the **"Raya · Next Edit"** channel.
...
- **No log lines appearing**: confirm the output channel is "Raya · Next Edit". Also confirm you reloaded the Dev Host after rebuilding.
