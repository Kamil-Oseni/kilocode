...
| Authentication | Generates one random 32-byte hex password and overwrites both `RAYA_SERVER_PASSWORD` and legacy `KILO_SERVER_PASSWORD`; writes username `kilo` through both aliases |
