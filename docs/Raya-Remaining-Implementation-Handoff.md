...
Focused evidence before commit: the pure matrix is 4/13, real database-client parity and storage cases are 5/7, core typecheck passes, and the bounded full CLI typecheck passes with one checker below the 5 GB stop boundary. Annotation, Promise-facade, formatting, Markdown-table, inventory and compatibility-ledger guards pass. The reviewed inventory is 68,931 total: public 1,693; compatibility 35,074; provenance 5,686; internal 26,478. Its compatibility digest is `0269138a6410a07fc84aedf3b15f47115d5b8186985068deedc557daf4a4a981`. Refresh and rebind the ledger after later changes that add, remove or reclassify a Kilo reference.
