...
export const dict = {
  ...
  "prompt.action.attach": "Bestanden bijvoegen",
  ...
  "sidebar.topBar.label": "Raya-navigatie",
  ...
  "deviceAuth.title": "Meld je aan bij Raya",
  ...
  "profile.action.login": "Inloggen met Raya",
  ...
  "settings.aboutKiloCode.title": "Over Raya",

  "session.messages.welcome":
    "Raya is een AI-codeerassistent. Vraag het om features te bouwen, bugs op te lossen of je codebase uit te leggen.",
  ...
  "settings.language.description": 'Kies de taal voor de Raya UI. "Auto" gebruikt je VS Code schermtaal.',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migreer instellingen van een eerdere installatie van Raya, inclusief provider API-sleutels en standaard model.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Wat is er Nieuw in Raya",
