...
export const dict = {
  "kilocode:autocomplete.statusBar.enabled": "$(raya-logo) 自動完成",
  "kilocode:autocomplete.statusBar.snoozed": "已暫停",
  "kilocode:autocomplete.statusBar.warning": "$(warning) 自動完成",
  "kilocode:autocomplete.statusBar.tooltip.basic": "Raya 自動完成",
  ...
  "kilocode:autocomplete.codeAction.title": "Raya：建議的編輯",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Raya 自動完成因與 GitHub Copilot 衝突而被封鎖。若要修正此問題，必須停用 Copilot 的內嵌建議。",
