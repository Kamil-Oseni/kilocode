...
export const dict = {
  ...
  "prompt.action.attach": "پیوست فایل‌ها",
  ...
  "workStyle.onboarding.welcome": "به Raya خوش آمدید",
  ...
  "workStyle.choice.human-in-the-loop.description": "Raya در حین کار مکث می‌کند و برنامه خود را به شما نشان می‌دهد.",
