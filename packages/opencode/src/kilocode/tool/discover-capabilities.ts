...
export const DiscoverCapabilitiesTool = Tool.define(
  ...
  Effect.succeed({
    description:
      "Discover known local file, text-artifact, document, spreadsheet and presentation creation/extraction, repository and chart capabilities exposed in this model turn. Use when capability or output-format support is unclear. Reports exact limitations; does not execute tools, grant permissions, connect accounts or list every business-service integration.",
