...
export const dict = {
  ...
  "speechToText.tooltip.start": "使用 Raya Gateway 開始語音輸入",
  ...
  "settings.models.hidePromptTraining.description": "隱藏供應商可能會使用您的提示詞進行訓練的 Raya Gateway 模型。",
  ...
  "workStyle.onboarding.welcome": "歡迎使用 Raya",
  ...
  "workStyle.choice.human-in-the-loop.description": "Raya 會在工作過程中暫停並向你顯示其計畫。",
  ...
  "profile.action.login": "使用 Raya 登入",
  ...
  "profile.usage.routing": "方案帳單目前有效。Raya Gateway 路由狀態為 {{state}}。",
  ...
  "profile.pass.subscribe": "訂閱 Raya Pass 以新增額度並賺取獎勵",
  ...
  "settings.aboutKiloCode.title": "關於 Raya",

  "session.messages.welcome": "Raya 是一個 AI 程式設計助手。讓它幫你建構功能、修復 bug 或解釋程式碼庫。",
  ...
  "settings.language.description": "選擇 Raya 介面的語言。「自動」使用 VS Code 的顯示語言。",
  ...
  "settings.experimental.remote.description": "透過 Raya Cloud 啟用工作階段的 Remote 控制。這也會影響此電腦上的 CLI。",
  ...
  "settings.aboutKiloCode.legacyMigration.description": "從舊版 Raya 安裝遷移設定，包括供應商 API 金鑰和預設模型。",
