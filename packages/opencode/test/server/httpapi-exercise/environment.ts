...
process.env.RAYA_DISABLE_SHARE = "true" // kilocode_change - exercise the Raya-first alias while preserving compatibility
...
process.env.RAYA_DISABLE_PRESENCE = "1" // kilocode_change - exercise the Raya-first alias while preserving compatibility
