...
export const dict = {
  "kilocode:autocomplete.statusBar.enabled": "$(raya-logo) 자동 완성",
  "kilocode:autocomplete.statusBar.snoozed": "일시 중지됨",
  "kilocode:autocomplete.statusBar.warning": "$(warning) 자동 완성",
  "kilocode:autocomplete.statusBar.tooltip.basic": "Raya 자동 완성",
  ...
  "kilocode:autocomplete.codeAction.title": "Raya: 제안된 편집",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Raya 자동 완성이 GitHub Copilot과의 충돌로 차단되고 있습니다. 이 문제를 해결하려면 Copilot의 인라인 제안을 비활성화해야 합니다.",
