...
export const dict = {
  ...
  "sidebar.topBar.label": "Навигация Raya",
  "sidebar.topBar.newTask": "Новая задача",
  "sidebar.topBar.history": "История",
  "sidebar.topBar.routines": "Рутины",
  ...
  "profile.action.login": "Войти через Raya",
  ...
  "settings.aboutKiloCode.title": "О Raya",

  "session.messages.welcome":
    "Raya — это AI-помощник для программирования. Попросите его создать функции, исправить ошибки или объяснить вашу кодовую базу.",
  ...
  "settings.language.description": "Выберите язык интерфейса Raya. «Авто» использует язык отображения VS Code.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Перенос настроек из предыдущей установки Raya, включая API-ключи провайдеров и модель по умолчанию.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Что нового в Raya",
