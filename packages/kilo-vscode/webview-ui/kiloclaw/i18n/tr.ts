export const dict = {
  "kiloClaw.loading": "Raya Messenger yükleniyor...",
  ...
  "kiloClaw.setup.description1":
    "Raya Messenger, e-postalarınızı okuyan, takviminizi yöneten, projelerinizi izleyen ve Telegram, Slack \u2014 halihazırda ne kullanıyorsanız orada yaşayan kişisel bir yapay zeka sunar.",
  ...
  "kiloClaw.upgrade.description2.before":
    "Botunuzla gerçek zamanlı sohbeti etkinleştirmek için Raya Messenger kontrol panelindeki ",
