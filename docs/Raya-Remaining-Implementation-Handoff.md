...
**Latest installed product:** `eden.raya@7.4.23-snapshot+6db117d0d5.kamil-oseni.1789353604821` is installed with package-vault digest `85f77680fcdbf4a075b7e902025c7f310aba27d35ba38385502e6b8cc85303e8`. The currently running host still identifies `eden.raya@7.4.23-snapshot+846c527c1b.kamil-oseni.1789348893826`, whose digest `8261c1ebfb4872827fd4d9db7272240d03a584678aae583efd77203f843ec973` remains active until reload. The user's real installed session and ChatGPT's native Office checks prove the earlier bundled artifact tools are usable; the latest package adds PPTX images plus safe formula and calendar-date cells. Product commit `2862bd059b` adds native Excel number formats and is pushed but not installed.
