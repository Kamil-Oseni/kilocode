...
const TIPS = [
  ...
  "Raya can {highlight}configure itself{/highlight} if you ask it",
  "Ask Raya to {highlight}add Supabase MCP globally{/highlight}",
  "Ask Raya to {highlight}create a review agent for this project{/highlight}",
  "Ask Raya to {highlight}add a plugin for desktop alerts{/highlight}",
  "Ask Raya to {highlight}set Claude Sonnet as my default model{/highlight}",
  "Ask Raya to {highlight}make my review agent read-only{/highlight}",
  "Ask Raya to {highlight}require approval before git push{/highlight}",
  "Ask Raya to {highlight}turn off auto-formatting{/highlight}",
  "Ask Raya to {highlight}block access to .env files{/highlight}",
  "Ask Raya to {highlight}turn off the F2 shortcut{/highlight}",
  "Ask Raya to {highlight}match my terminal theme{/highlight}",
  "Ask Raya to {highlight}disable sharing for all sessions{/highlight}",
  "Ask Raya to {highlight}add rules from docs/ai-rules.md{/highlight}",
  "Ask Raya to {highlight}enable tui.scroll_acceleration{/highlight} for smooth macOS-style scrolling",
  "Ask Raya to {highlight}save this workflow as a /command{/highlight}",
  "Raya auto-handles OAuth for remote MCP servers requiring auth",
  "Raya auto-formats files using prettier, gofmt, ruff, and more",
  "Raya uses LSP servers for intelligent code analysis",
  ...
  "Run {highlight}kilo serve{/highlight} for headless API access to Raya",
