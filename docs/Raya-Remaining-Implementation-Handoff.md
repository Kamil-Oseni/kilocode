...
**Latest installed product:** `eden.raya@7.4.23-snapshot+f1dc505270.kamil-oseni.1789351852022` is installed with package-vault digest `ca15f65d9f85db83f239ce042608cbe5a353ab50c43a481742ddde9b95f85423`. The currently running host still identifies `eden.raya@7.4.23-snapshot+846c527c1b.kamil-oseni.1789348893826`, whose digest `8261c1ebfb4872827fd4d9db7272240d03a584678aae583efd77203f843ec973` remains active until reload. The user's real installed session and ChatGPT's native Office checks prove the earlier bundled artifact tools are usable; the latest package includes the subsequent DOCX/PPTX table and DOCX image work.
