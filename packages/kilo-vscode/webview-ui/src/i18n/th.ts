...
export const dict = {
  ...
  "workStyle.onboarding.welcome": "ยินดีต้อนรับสู่ Raya",
  ...
  "workStyle.choice.human-in-the-loop.description": "Raya จะหยุดและแสดงแผนให้คุณเห็นระหว่างการทำงาน",
  ...
  "deviceAuth.title": "เข้าสู่ระบบ Raya",
  ...
  "profile.action.login": "เข้าสู่ระบบด้วย Raya",
  ...
  "settings.aboutKiloCode.title": "เกี่ยวกับ Raya",

  "session.messages.welcome": "Raya เป็นผู้ช่วยเขียนโค้ด AI ขอให้สร้างฟีเจอร์ แก้ไขบัก หรืออธิบายโค้ดเบสของคุณ",
  ...
  "settings.language.description": 'เลือกภาษาสำหรับ UI ของ Raya "อัตโนมัติ" จะใช้ภาษาการแสดงผลของ VS Code',
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "ย้ายการตั้งค่าจากการติดตั้ง Raya ก่อนหน้านี้ รวมถึงคีย์ API ของผู้ให้บริการและโมเดลเริ่มต้น",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "มีอะไรใหม่ใน Raya",
