...
const entries: Entry[] = [
  ...
  },
  {
    ...
    name: "Create a PDF",
    tools: ["create_pdf"],
    inputs: ["structured text", "headings", "lists", "tables", "local PNG/JPEG images", "http/https links", "PDF"],
    description: "Create a local paginated PDF with text, tables, permission-reviewed images and clickable links.",
