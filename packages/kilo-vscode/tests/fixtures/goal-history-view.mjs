...
assert.ok(!root.textContent.includes("Current saved requirement"))
assert.ok(root.textContent.includes("Evidence references accepted"))
assert.ok(root.textContent.includes("Saved deliverable and checks"))
assert.ok(root.textContent.includes("Evidence-reference acceptance is not user acceptance."))
