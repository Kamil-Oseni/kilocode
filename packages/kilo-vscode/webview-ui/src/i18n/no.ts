...
export const dict = {
  ...
  "sidebar.topBar.label": "Raya-navigasjon",
  ...
  "settings.models.hidePromptTraining.description":
    "Skjul Raya Gateway-modeller der leverandørene kan bruke ledetekstene dine til trening.",
  ...
  "workStyle.choice.human-in-the-loop.description": "Raya tar pause og viser deg planen sin mens den arbeider.",
  ...
  "deviceAuth.title": "Logg inn på Raya",
  ...
  "profile.action.login": "Logg inn med Raya",
  ...
  "profile.usage.routing": "Abonnementsfakturering er aktiv. Raya Gateway-ruting er {{state}}.",
  ...
  "profile.pass.subscribe": "Få Raya Pass for å legge til kreditt og tjene bonuser",
  "profile.pass.bonus": "Bonus",
  "profile.pass.usage": "Denne månedens forbruk",
  "profile.pass.paid": "Betalt",
  "profile.pass.meter": "Månedlig Raya Pass-forbruk",
  ...
  "session.messages.welcome":
    "Raya er en AI-kodingsassistent. Be den om å bygge funksjoner, fikse feil eller forklare kodebasen din.",
  ...
  "settings.language.description": 'Velg språket for Raya-grensesnittet. "Auto" bruker VS Codes visningsspråk.',
  ...
  "settings.experimental.remote.description":
    "Aktiver Remote-kontroll av økter via Raya Cloud. Dette vil også påvirke CLI-er på denne maskinen.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "Migrer innstillinger fra en tidligere installasjon av Raya, inkludert API-nøkler for leverandører og standardmodell.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Hva er nytt i Raya",
