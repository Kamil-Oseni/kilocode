...
export const dict = {
  "kilocode:autocomplete.statusBar.enabled": "$(raya-logo) Autofuldførelse",
  "kilocode:autocomplete.statusBar.snoozed": "udsat",
  "kilocode:autocomplete.statusBar.warning": "$(warning) Autofuldførelse",
  "kilocode:autocomplete.statusBar.tooltip.basic": "Raya autofuldførelse",
  ...
  "kilocode:autocomplete.codeAction.title": "Raya: Foreslåede redigeringer",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Raya autofuldførelse blokeres af en konflikt med GitHub Copilot. For at løse dette skal du deaktivere Copilots inline-forslag.",
