...
const KILO_DISABLE_CLAUDE_CODE = EnvAlias.enabled("RAYA_DISABLE_CLAUDE_CODE", "KILO_DISABLE_CLAUDE_CODE")
const prompt = EnvAlias.enabled("RAYA_DISABLE_CLAUDE_CODE_PROMPT", "KILO_DISABLE_CLAUDE_CODE_PROMPT")
const skills = EnvAlias.enabled("RAYA_DISABLE_CLAUDE_CODE_SKILLS", "KILO_DISABLE_CLAUDE_CODE_SKILLS")
const KILO_DISABLE_CLAUDE_CODE_PROMPT = KILO_DISABLE_CLAUDE_CODE || prompt
const KILO_DISABLE_CLAUDE_CODE_SKILLS = KILO_DISABLE_CLAUDE_CODE || skills
// kilocode_change end
