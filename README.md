<!-- kilocode_change start - identify the Raya fork's distribution contract -->
> **Raya fork:** For this repository's extension, platform coverage and feature differences, see [Raya supported clients](docs/Raya-Supported-Clients.md). Raya installs as `eden.raya`; the Kilo Marketplace, npm and cloud links below describe upstream products.
<!-- kilocode_change end -->
