export const dict = {
  "kiloClaw.loading": "Raya Messenger laden...",
  ...
  "kiloClaw.setup.description1":
    "Raya Messenger biedt je een persoonlijke AI die e-mails leest, je agenda beheert, je projecten bewaakt, en actief is in Telegram, Slack \u2014 of wat je al gebruikt.",
  ...
  "kiloClaw.upgrade.description2.after": " op het Raya Messenger-dashboard om realtime chat met je bot te activeren.",
