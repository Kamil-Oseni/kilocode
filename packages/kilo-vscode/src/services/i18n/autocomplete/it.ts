...
export const dict = {
  "kilocode:autocomplete.statusBar.enabled": "$(raya-logo) Completamento automatico",
  ...
  "kilocode:autocomplete.statusBar.tooltip.basic": "Completamento automatico Raya",
  ...
  "kilocode:autocomplete.codeAction.title": "Raya: modifiche suggerite",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Il completamento automatico di Raya è bloccato da un conflitto con GitHub Copilot. Per risolvere il problema, devi disabilitare i suggerimenti inline di Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Il completamento automatico di Raya è stato messo in pausa. Possibili cause: il tuo account Kilo non ha crediti residui, oppure la chiave API configurata (BYOK) ha raggiunto il limite di quota. Aggiungi crediti Kilo o controlla la configurazione della chiave API per riprendere il completamento automatico.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Aggiungi crediti",
  "kilocode:autocomplete.authError.message":
    "Il completamento automatico di Raya è stato messo in pausa a causa di un problema di autenticazione. Possibili cause: non hai effettuato l’accesso a Kilo, oppure la tua chiave API (BYOK) non è valida o manca. Accedi di nuovo o controlla le impostazioni della chiave API del provider.",
}
