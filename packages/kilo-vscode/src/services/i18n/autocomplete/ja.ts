...
export const dict = {
  "kilocode:autocomplete.statusBar.enabled": "$(raya-logo) オートコンプリート",
  "kilocode:autocomplete.statusBar.snoozed": "一時停止中",
  "kilocode:autocomplete.statusBar.warning": "$(warning) オートコンプリート",
  "kilocode:autocomplete.statusBar.tooltip.basic": "Raya オートコンプリート",
  ...
  "kilocode:autocomplete.codeAction.title": "Raya: 提案された編集",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Raya オートコンプリートは GitHub Copilot との競合によりブロックされています。修正するには、Copilot のインライン提案を無効にする必要があります。",
