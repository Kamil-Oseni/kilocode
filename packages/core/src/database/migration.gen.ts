...
export const migrations = (
  await Promise.all([
    ...
    import("./migration/20260908092112_kilocode-routine-occurrence"), // kilocode_change
    import("./migration/20260908124554_kilocode-routine-archive"), // kilocode_change
    import("./migration/20260910044904_kilocode-voice-binding"), // kilocode_change
    import("./migration/20260911033250_kilocode-routine-inbox"), // kilocode_change
    import("./migration/20260911183445_kilocode-routine-delegation"), // kilocode_change
    import("./migration/20260911194749_kilocode-routine-delegation-cost"), // kilocode_change
    import("./migration/20260911234600_kilocode-routine-inbox-files"), // kilocode_change
    ...
    import("./migration/20260916221534_kilocode-routine-draft-revision"), // kilocode_change
    import("./migration/20260917021944_kilocode-routine-organization-budget"), // kilocode_change
    import("./migration/20260917035533_kilocode-contact-outbox"), // kilocode_change
    import("./migration/20260921060802_kilocode-routine-delegation-artifacts"), // kilocode_change
    import("./migration/20260921084500_kilocode-routine-organization-reservation"), // kilocode_change
    import("./migration/20260921093000_kilocode-routine-organization-coordinator"), // kilocode_change
    import("./migration/20260925201938_kilocode-routine-organization-stop"), // kilocode_change
    import("./migration/20260926010000_kilocode-private-desktop-frames"), // kilocode_change
  ])
