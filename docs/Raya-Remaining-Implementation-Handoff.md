...
**Latest installed product:** `eden.raya@7.4.23-snapshot+846c527c1b.kamil-oseni.1789348893826` is installed and its package-vault digest `8261c1ebfb4872827fd4d9db7272240d03a584678aae583efd77203f843ec973` is active. Its package-vault artifact is `raya.8261c1ebfb4872827fd4d9db7272240d03a584678aae583efd77203f843ec973.vsix`; the staged duplicate was removed by the retention phase. The user's real installed session and ChatGPT's native Office checks prove the bundled artifact tools are usable.
