...
export const dict = {
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Il completamento automatico di Raya è stato messo in pausa. Possibili cause: il tuo account Raya non ha crediti residui, oppure la chiave API configurata (BYOK) ha raggiunto il limite di quota. Aggiungi crediti Raya o controlla la configurazione della chiave API per riprendere il completamento automatico.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Aggiungi crediti",
  "kilocode:autocomplete.authError.message":
    "Il completamento automatico di Raya è stato messo in pausa a causa di un problema di autenticazione. Possibili cause: non hai effettuato l’accesso a Raya, oppure la tua chiave API (BYOK) non è valida o manca. Accedi di nuovo o controlla le impostazioni della chiave API del provider.",
}
