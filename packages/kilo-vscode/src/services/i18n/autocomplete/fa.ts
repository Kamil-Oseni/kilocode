...
export const dict = {
  "kilocode:autocomplete.statusBar.enabled": "$(raya-logo) تکمیل خودکار",
  "kilocode:autocomplete.statusBar.snoozed": "به تعویق افتاده",
  "kilocode:autocomplete.statusBar.warning": "$(warning) تکمیل خودکار",
  "kilocode:autocomplete.statusBar.tooltip.basic": "تکمیل خودکار Raya",
  ...
  "kilocode:autocomplete.codeAction.title": "Raya: ویرایش‌های پیشنهادی",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "تکمیل خودکار Raya به دلیل تعارض با GitHub Copilot مسدود شده است. برای رفع این مشکل، باید پیشنهادات درون‌خطی Copilot را غیرفعال کنید.",
