...
#
# Raya already copies root-level .env and .env.* files before this script runs.
...
export const SETUP_SCRIPT_TEMPLATE_POWERSHELL = `# Raya Worktree Setup Script
# This script runs before the agent starts in a worktree (new sessions only).
#
# Available environment variables:
