...
export const dict = {
  "kilocode:autocomplete.statusBar.enabled": "$(raya-logo) Autovervollständigung",
  "kilocode:autocomplete.statusBar.snoozed": "pausiert",
  "kilocode:autocomplete.statusBar.warning": "$(warning) Autovervollständigung",
  "kilocode:autocomplete.statusBar.tooltip.basic": "Raya Autovervollständigung",
  ...
  "kilocode:autocomplete.codeAction.title": "Raya: Vorgeschlagene Änderungen",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Raya Autovervollständigung wird durch einen Konflikt mit GitHub Copilot blockiert. Um dies zu beheben, musst du die Inline-Vorschläge von Copilot deaktivieren.",
