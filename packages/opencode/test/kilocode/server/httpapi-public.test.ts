...
describe("Kilo PublicApi OpenAPI contract", () => {
  test("presents Raya while retaining the compatible API surface", () => {
    ...
    for (const legacy of [
      ...
      "Kilo Gateway routes",
      "Kilo HttpApi",
      "Kilo agent builder routes",
      "Kilo background process routes",
      "Kilo branch name routes",
      "Kilo direct child-session steering routes",
      "Kilo commit message routes",
      "Kilo Console config routes",
      "Kilo enhance prompt routes",
      "Kilo indexing routes",
      "Kilo instance reload route",
      "Kilo human-driven interactive terminal routes",
      "Kilo-specific routes",
      "Kilo memory routes",
      "Kilo network routes",
      "Kilo remote connection routes",
      "Kilo session sandbox routes",
      "Kilo legacy session import routes",
      "Kilo suggestion routes",
      "Kilo telemetry routes",
      "Kilo provider authentication metadata",
      "Kilo embedding model catalog",
      "List Kilo embedding models",
      "active Kilo account",
      "files used by Kilo",
      "shared with Kilo Console",
      "current Kilo instance",
      "the Kilo server",
      "the Kilo system",
      "global Kilo configuration",
      "all Kilo instances",
      "Upgrade kilo",
      "current Kilo configuration",
      "specific Kilo session",
      "new Kilo session",
      "opened with Kilo",
      "project that Kilo",
      "managed by Kilo",
