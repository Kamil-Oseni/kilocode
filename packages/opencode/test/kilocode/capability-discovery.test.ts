...
it.instance(
  ...
  () =>
    Effect.gen(function* () {
      ...
      expect(source).toContain("/AcroForm ")
      expect(source).toContain("/NeedAppearances true")
      expect(source).toContain("/Subtype /Widget /FT /Tx")
      expect(source).toContain("/T <7265766965776572>".toUpperCase())
      ...
      for (const input of [
        ...
        {
          filePath: path.join(instance.directory, "too-many-fields.pdf"),
