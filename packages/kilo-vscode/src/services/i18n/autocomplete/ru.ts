...
export const dict = {
  "kilocode:autocomplete.statusBar.enabled": "$(raya-logo) Автодополнение",
  "kilocode:autocomplete.statusBar.snoozed": "отложено",
  "kilocode:autocomplete.statusBar.warning": "$(warning) Автодополнение",
  "kilocode:autocomplete.statusBar.tooltip.basic": "Автодополнение Raya",
  ...
  "kilocode:autocomplete.codeAction.title": "Raya: Предлагаемые правки",
  "kilocode:autocomplete.incompatibilityExtensionPopup.message":
    "Автодополнение Raya блокируется из-за конфликта с GitHub Copilot. Чтобы исправить это, необходимо отключить встроенные предложения Copilot.",
  ...
  "kilocode:autocomplete.creditsExhausted.message":
    "Автодополнение Raya приостановлено. Возможные причины: на вашем аккаунте Kilo не осталось кредитов или настроенный API-ключ (BYOK) достиг лимита квоты. Добавьте кредиты Kilo или проверьте конфигурацию API-ключа, чтобы возобновить автодополнение.",
  "kilocode:autocomplete.creditsExhausted.addCredits": "Добавить кредиты",
  "kilocode:autocomplete.authError.message":
    "Автодополнение Raya приостановлено из-за проблемы с аутентификацией. Возможные причины: вы не вошли в Kilo или ваш API-ключ (BYOK) недействителен либо отсутствует. Войдите снова или проверьте настройки API-ключа провайдера.",
}
