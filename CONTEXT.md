...
- Ambient project instruction discovery honors `RAYA_DISABLE_PROJECT_CONFIG`, with `KILO_DISABLE_PROJECT_CONFIG` retained as its compatibility fallback; global instructions remain eligible.
