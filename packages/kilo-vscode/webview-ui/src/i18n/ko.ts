...
export const anacondaDesktopDict = {
  ...
  "provider.anaconda.state.notInstalled":
    "이 컴퓨터에 Anaconda Desktop을 설치한 후 여기로 돌아오세요. Raya는 설치 프로그램을 대신 실행하지 않습니다.",
  ...
  "provider.anaconda.state.signedOut": "Raya를 연결하기 전에 Anaconda Desktop을 열고 로그인하세요.",
  "provider.anaconda.state.unauthorized":
    "Raya가 Anaconda Desktop에 접근할 수 없습니다. Desktop을 열고 다시 로그인한 후 필요하면 다시 시작하세요.",
  ...
  "provider.anaconda.state.ready":
    "Raya가 정상적인 로컬 텍스트 생성 서버를 찾았으며 현재 연결 설정을 가져올 수 있습니다.",
  ...
  "provider.anaconda.toast.refreshed.description": "활성 로컬 서버와 모델이 Raya에서 최신 상태입니다.",
...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "{{provider}} API 키를 입력하여 계정을 연결하고 Raya에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "를 방문하여 인증 코드를 받아 계정을 연결하고 Raya에서 {{provider}} 모델을 사용하세요.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "를 방문하고 아래 코드를 입력하여 계정을 연결하고 Raya에서 {{provider}} 모델을 사용하세요.",
  ...
  "prompt.action.sandbox.enabled":
    "샌드박스가 활성화되어 있습니다. 에이전트 셸 명령은 프로젝트 및 Raya 디렉터리로 제한됩니다.",
  "prompt.action.sandbox.disabled":
    "샌드박스가 비활성화되어 있습니다. 클릭하여 에이전트 셸 명령 쓰기를 프로젝트 및 Raya 디렉터리로 제한합니다.",
  ...
  "prompt.action.sandbox.description.enabled": "쓰기는 프로젝트 및 Raya 디렉터리로 제한됩니다.",
  ...
  "speechToText.error.loginRequired": "음성 입력을 사용하려면 Raya에 로그인하세요.",
  ...
  "settings.config.title": "{{scope}} Raya 구성 파일 열기",
  "settings.config.placeholder":
    "구성 파일은 순서대로 병합됩니다. 로드됨으로 표시된 파일이 현재 설정에 영향을 미칩니다.",
  "settings.config.noWorkspace": "로컬 Raya 구성 파일을 편집하려면 작업 영역 폴더를 엽니다.",
  "settings.config.openFailed": "{{scope}} Raya 구성 파일을 열지 못했습니다: {{message}}",
  ...
  "workStyle.onboarding.welcome": "Raya에 오신 것을 환영합니다",
  ...
  "workStyle.choice.human-in-the-loop.description": "Raya가 작업 중에 잠시 멈추고 계획을 보여줍니다.",
  ...
  "profile.action.login": "Raya로 로그인",
  ...
  "settings.indexing.kiloModel.title": "Raya 모델 프리셋",
  "settings.indexing.kiloModel.description": "지원되는 Raya 호스팅 임베딩 모델을 선택하세요.",
  "settings.indexing.kiloSignIn.title": "Raya 로그인이 필요합니다",
  "settings.indexing.kiloSignIn.description": "호스팅 임베딩을 사용하려면 Raya에 로그인하세요.",
  ...
  "session.messages.welcome":
    "Raya는 AI 코딩 어시스턴트입니다. 기능 구축, 버그 수정 또는 코드베이스 설명을 요청하세요.",
  ...
  "settings.aboutKiloCode.importSettings.invalidConfig": "파일에 유효한 Raya 설정이 포함되어 있지 않습니다.",
  "settings.aboutKiloCode.importSettings.tooLarge": "파일이 너무 큽니다. 설정 파일은 1 MB 이하여야 합니다.",
  "settings.aboutKiloCode.importSettings.newerVersion":
    "이 파일은 더 최신 버전의 Raya에서 내보낸 것입니다. 일부 설정이 무시될 수 있습니다.",
  ...
  "settings.language.description": 'Raya UI의 언어를 선택하세요. "자동"은 VS Code 표시 언어를 사용합니다.',
  ...
  "settings.models.speechToText.disabledDescription":
    "Speech to Text를 사용하려면 Raya 제공자를 활성화하고 로그인하세요. 현재 Speech to Text는 Raya Gateway에서만 지원됩니다.",
  ...
  "settings.agentBehaviour.claudeCompat.description":
    "Claude Code 설정 디렉터리에서 세션으로 CLAUDE.md 지침 및 스킬을 로드합니다. Raya가 Claude Code 지침 및 스킬을 사용하게 하려면 활성화하세요. 다시 시작해야 합니다.",
  ...
  "settings.sandboxing.enabled.description":
    "에이전트 셸 명령을 프로젝트 및 Raya 상태 디렉터리에 대한 쓰기를 제한하는 OS 수준의 샌드박스 내에서 실행",
  ...
  "settings.display.fontSize.description": "VS Code와 독립적으로 Raya webview UI 글꼴 크기를 조정합니다.",
  ...
  "settings.aboutKiloCode.legacyMigration.description":
    "공급자 API 키 및 기본 모델을 포함하여 이전 Raya 설치에서 설정을 마이그레이션합니다.",
  ...
  // Screen 1 — What's New
  "migration.whatsNew.title": "Raya의 새로운 기능",
  ...
  "migration.whatsNew.features.foundation.detail":
    "모든 Raya 제품에 걸쳐 하나의 작고 효율적인 코어. 어떤 방식으로 작업하든 익숙한 경험을 제공합니다.",
  ...
  "diffViewer.source.session.tooltip":
    "현재 세션 동안 Raya가 변경한 파일로, 턴별 스냅샷을 기반으로 합니다. 새 세션을 시작하면 초기화됩니다.",
