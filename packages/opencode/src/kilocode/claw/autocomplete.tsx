...
export function ClawAutocomplete(props: {
  ...
  useBindings(() => ({
    ...
    bindings: [
      { key: "up", desc: "Previous command", group: "Raya Messenger", cmd: () => move(-1) },
      { key: "ctrl+p", desc: "Previous command", group: "Raya Messenger", cmd: () => move(-1) },
      { key: "down", desc: "Next command", group: "Raya Messenger", cmd: () => move(1) },
      { key: "ctrl+n", desc: "Next command", group: "Raya Messenger", cmd: () => move(1) },
      { key: "escape", desc: "Hide autocomplete", group: "Raya Messenger", cmd: hide },
      { key: "return", desc: "Select command", group: "Raya Messenger", cmd: select },
      { key: "tab", desc: "Select command", group: "Raya Messenger", cmd: select },
      {
        key: "right",
        fallthrough: true,
        cmd: () => {
